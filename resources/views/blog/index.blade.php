    ...
    <div class="hero first-container">
        <div>
            ...
            <div class="cta-wrapper">
                <a href="#projects" type="button" class="cta">Prtofolio</a>
            </div>
        </div>
    </div>
    <div class="arrow-up-wrapper">
        <div class="arrow-up" id="back_to_top">
            <a href=""><img src="{{ asset('/images/icons8-upward-arrow-64.png') }}" alt=""  class="arrow_section"></a>
        </div>
    </div>
</section>
{{--end first section--}}
...
<section id="about">
    <div class="about first-container">
        ...
        <div class="column-right">
            <h1 class="section-title">Lorem <span>ipsum.</span></h1>
